...
val TextDefaultBlack = Color(0xFF101828)
...
val Card3 = Color(0xFFAED581)  // Verde lima medio
val Card4 = Color(0xFFCE93D8)  // Lila medio
val Card5 = Color(0xFFFFB74D)  // Naranja medio
val Card6 = Color(0xFFFFD180)  // Amarillo miel medio
...
val ButtonDarkWarning = Color(0xFFF57C00)
...
val FondoEncabezadoFinales = Color(0xFF1B5E20)

val FondoFilaPar = Color(0xFFFFFFFF)
val FondoFilaImpar = Color(0xFFEEEEEE)
val TextoEncabezado = Color.White
...
val VioletaClaroLight = Color(0xFFE9D7F0)
val NaranjaClaroLight = Color(0xFFFFD49A)
val NaranjaClaroLight2 = Color(0xFFE8C89C)
val RojoClaroLight = Color(0xFFF5B9B8)
...
val TextoOscuro = Color(0xFF18192A)
...
val DarkBrown = Color(0xFF140F07)

/** Azul marino intenso (RGB: 29,37,70) - Perfecto para barras de navegación */
val NavyBlue = Color(0xFF1D2546)

/** Azul real vibrante (RGB: 76,92,164) - Excelente para botones principales */
val RoyalBlue = Color(0xFF4C5CA4)

/** Azul cielo claro (RGB: 134,158,252) - Para acentos y fondos claros */
val LightBlue = Color(0xFF869EFC)

/** Azul hielo muy claro (RGB: 209,235,247) - Fondos claros y elementos secundarios */
val IceBlue = Color(0xFFD1EBF7)

/** Rosa fucsia intenso (RGB: 212,0,98) - Para alerts y elementos destacados */
val HotPink = Color(0xFFD40062)

/** Púrpura vino tinto (RGB: 132,51,88) - Elegante para detalles */
val DeepPurple = Color(0xFF843358)

/** Naranja vibrante (RGB: 253,119,36) - Llamativo para CTAs */
val VibrantOrange = Color(0xFFFD7724)

/** Rojo óxido oscuro (RGB: 134,61,51) - Para advertencias */
val Rust = Color(0xFF863D33)

/** Dorado suave (RGB: 255,210,97) - Para acentos premium */
